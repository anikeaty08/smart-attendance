...
export default function HodCorrectionsPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const res = await fetch(`${API_BASE}/hod/corrections?page=1&page_size=200`, { headers: { Authorization: `Bearer ${token}` } });
      if (!res.ok) return;
  ...
  return (
    <DashboardLayout role="hod" pageTitle="Corrections">
