...
export default function HodSubstitutesPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const res = await fetch(`${API_BASE}/hod/substitutes`, { headers: { Authorization: `Bearer ${token}` } });
      if (!res.ok) return;
  ...
  return (
    <DashboardLayout role="hod" pageTitle="Substitutes">
