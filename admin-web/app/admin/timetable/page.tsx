...
export default function AdminTimetablePage() {
  ...
  async function upload() {
    ...
    await fetch(`${API_BASE}/admin/timetable/upload`, { method: "POST", headers: { Authorization: `Bearer ${token}` }, body: form });
    await load();
  }
  ...
  return (
    <DashboardLayout role="admin" pageTitle="Timetable">
      <div className="mb-4 flex gap-2"><input ref={fileRef} type="file" accept=".csv,.xlsx,.xls" /><button onClick={upload}>Upload</button></div>
