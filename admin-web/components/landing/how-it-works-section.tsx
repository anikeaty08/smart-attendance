...
const steps = [
  {
    number: "01",
    title: "Teacher",
    subtitle: "activates session",
    description: "Teacher opens the app and clicks 'Start Attendance' for their class. System generates a unique temporary code valid for the session.",
    code: `Session Code: 7x2mK9
Active for: 12:00 - 12:50 PM
Class: CSE-A-101
Students: 60`,
  },
  {
    number: "02",
    title: "Student",
    subtitle: "enters code",
    description: "Students see the code displayed and enter it in their app along with submitting their attendance within the 10-meter radius.",
    code: `Enter Code: ______
Location: Active ✓
...
Tap 'Submit Attendance'`,
  },
  {
    number: "03",
    title: "System",
    subtitle: "verifies & records",
    description: "System verifies proximity, validates the code, and instantly records attendance. Teachers see live updates on their dashboard.",
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-16 opacity-0"
              ...
              <span className="block text-white/10">Record.</span>
            </h2>
          </div>
