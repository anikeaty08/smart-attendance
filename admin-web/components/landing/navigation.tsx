      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight font-bold transition-all duration-500 ${isScrolled ? "text-lg text-foreground" : "text-2xl text-white"}`}>InSync</span>
            <span className={`text-xs font-semibold transition-all duration-500 ${isScrolled ? "text-muted-foreground" : "text-white/60"}`}>Attendance</span>
          </a>
