...
const securityFeatures = [
  {
    ...
    description: "Temporary codes valid only for each session prevent unauthorized access.",
  ...
  },
  {
    ...
    description: "Every attendance mark logged with timestamp and location verification.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Role-based access",
    description: "Teachers, students, and admins have appropriate permission boundaries.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["Data Protection", "Student Privacy", "Location Security", "Compliance Ready"];
